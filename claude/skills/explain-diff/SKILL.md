...
4. **Intuition**: explain the core idea behind the change as its essence, not its full detail. Lean heavily on small concrete examples (simplified just enough that only the essence is visible) and diagrams.
