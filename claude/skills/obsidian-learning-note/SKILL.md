...
- **Always end the body with the Claude Code footer** (`🤖 Generated with [Claude Code](https://claude.com/claude-code)`), on its own line after a blank line — same convention as the daily-report skill's report template. This marks the note as AI-generated for traceability.
...
- **Include the Claude Code footer** — for traceability, same as the daily-report skill.
